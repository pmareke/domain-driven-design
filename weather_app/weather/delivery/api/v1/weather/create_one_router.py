...
from weather_app.weather.use_cases.create_one_weather_command import (
    CreateOneWeatherCommand,
    CreateOneWeatherCommandHandler,
)
...
def create_weather(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"The request id: {weather_request.weather_id}, temperature: {weather_request.temperature}, city: {weather_request.city} is not valid",
        ) from exception
