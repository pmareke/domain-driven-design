...
from weather_app.weather.delivery.api.v1.weather.weather_update_request import (
    WeatherUpdateRequest,
)
from weather_app.weather.domain.command_handler import CommandHandler
from weather_app.weather.domain.weather import (
    WeatherNotFoundException,
    WeatherInvalidException,
)
...
def update_weather(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"The request id: {weather_id}, temperature: {weather_request.temperature}, city: {weather_request.city} is not valid",
        ) from exception
